...
pipeline {
    ...
    stages {
        stage('Build + SonarQube analysis') {
            steps {
                ...
                withSonarQubeEnv('Huckshome SonarQube Server') {
                    ...
                    bat '"C:\\Program Files (x86)\\Microsoft Visual Studio\\2017\\Professional\\MSBuild\\15.0\\Bin\\amd64\\MSBuild.exe" %strProjectName%.sln /t:Build /p:Configuration=Debug'
        ...
        stage('Build for Release') {
            steps {
				bat '"C:\\Program Files (x86)\\Microsoft Visual Studio\\2017\\Professional\\MSBuild\\15.0\\Bin\\amd64\\MSBuild.exe" "%strProjectName%/%strProjectName%.csproj" /T:Rebuild /p:Configuration=Release /p:OutputPath="obj\\Release"'
            }
        }
